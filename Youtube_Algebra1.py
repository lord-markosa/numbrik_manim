...
class AlgebraIntroduction(Scene):
    def construct(self):
        # Title
        title = (
            Text("Introduction to Algebra", color=NUMBRIK_COLOR)
            .scale(1.2)
        ...
        equation2 = MathTex("2 + 5 - 6/2 = 4").next_to(equation, DOWN, buff=0.5)
        ...
        bodmas = Text("BODMAS").scale(1.2).move_to(TITLE_TEXT_POSITION + 2 * UP)
        ...
        brackets = Text("Brackets", color=PURPLE).next_to(bodmas, DOWN, buff=0.5)
        ...
        multiplication = Text("Multiplication", color=YELLOW).next_to(division, DOWN)
        ...
        equation3 = MathTex("2 +", "something", "= 5").move_to(TITLE_TEXT_POSITION)
        equation3[1].set_color(ORANGE)
        equation4 = MathTex("2 +", "something", "-2", "= 5 - 2").next_to(
            equation3, DOWN, buff=0.5
        )
        equation4[1].set_color(ORANGE)
        equation5 = MathTex("something", "= 3").next_to(equation4, DOWN, buff=0.5)
        ...
        equation6 = MathTex("2 + x = 5").move_to(TITLE_TEXT_POSITION + 2 * UP)
        description = Text("where x is a variable").next_to(equation6, DOWN).scale(0.5)
        self.play(Write(equation6), run_time=1.5)
        self.play(Write(description), run_time=1.5)
        self.wait(2)

        equation7 = MathTex("x + x + x = 6").next_to(description, DOWN, buff=0.5)
        self.play(Write(equation7), run_time=1.5)
        self.wait(2)

        equation8_1 = MathTex("x + x + x + x... (100) = 400").next_to(
            equation7, DOWN, buff=0.5
        )
        self.play(Write(equation8_1), run_time=1.5)
        self.wait(1)
        equation8 = MathTex(r"\Rightarrow 100 \times x = 400").next_to(
            equation8_1, DOWN, buff=0.5
        )
        self.play(Write(equation8), run_time=1.5)
        self.wait(1)
        equation9 = MathTex(r"\Rightarrow 100x = 400").next_to(
            equation8, DOWN, buff=0.5
        )
        ...
        # Expressions
        equation10 = MathTex("A", "x", "+", "B").move_to(TITLE_TEXT_POSITION)
        self.play(Write(equation10), run_time=1.5)
        self.play(
            equation10[0].animate.set_color(BLUE), equation10[1].animate.set_color(BLUE)
        )
        self.play(equation10[3].animate.set_color(GREEN))

        equation11 = MathTex("3", r"\cdot", "2", "+", "4", "=", "10").next_to(
            equation10, DOWN, buff=0.5
        )
        ...
        # Equations
        desc2 = Text("Equations", color=NUMBRIK_COLOR).move_to(TITLE_TEXT_POSITION + UP)
        ...
        equation14_1 = MathTex(r"x + x + x + x").move_to(TITLE_TEXT_POSITION + UP)
