...
class AlgebraicOperations(Scene):
    def construct(self):
        ...
        eqn1 = MathTex("2x", "+", "5", "+",
                       "3").move_to(TITLE_TEXT_POSITION + UP)
        ...
        eqn3 = MathTex("2x", "+", "5", "+", "3x", "+",
                       "2").next_to(eqn2, DOWN, buff=0.5)
        self.play(Write(eqn3), run_time=1.5)
        self.play(eqn3[0].animate.set_color(RED),
                  eqn3[4].animate.set_color(RED))
        self.play(eqn3[2].animate.set_color(GREEN),
                  eqn3[6].animate.set_color(GREEN))

        self.wait(2)

        eqn3_ = MathTex("2x", "+", "3x", "+", "5", "+",
                        "2").next_to(eqn2, DOWN, buff=0.5)
        ...
        eqn6 = MathTex(
            r" \frac{3x^2y + 6xy + 9x^2y + 3y^2x + 18}{3xy}").move_to(TITLE_TEXT_POSITION + 2*UP)
        eqn6[0][0:4].set_color(GREEN)
        eqn6[0][9:13].set_color(GREEN)

        eqn7 = MathTex(
            r"\frac{12x^2y + 6xy + 3y^2x + 18}{3xy}").next_to(eqn6, DOWN, buff=0.5)

        eqn8 = MathTex(
            r"\frac{12x^2y}{3xy} + \frac{6xy}{3xy} + \frac{3y^2x}{3xy} + \frac{18}{3xy}").next_to(eqn7, DOWN, buff=0.5)

        eqn9 = MathTex(
            r"4x + 2 + y + \frac{6}{xy}").next_to(eqn8, DOWN, buff=0.5)
