    ...
    def construct(self):
        ...
        animateTextSeq(
            ...
            [
                ...
                Text("When is this expression equal to 14?").scale(0.6),
            ],
        )
        ...
        animateTextSeq(
            self,
            [
                Text("Speed up using these").scale(0.8),
                Text("Move terms directly to the other side").scale(0.6),
        ...
        animateTextSeq(
            self,
            [
                MathTex("4(3x + 2) = 4x + 16"),
                MathTex("(3x + 2)} = \\frac{4x + 16}{4}"),
                MathTex("3x + 2 = x + 4"),
                MathTex("3x = x + 4 - 2"),
            ],
        )
        ...
        animateTextSeq(
            self,
            [
                Text("And that’s how we solve an equation!").scale(0.6),
                MathTex("5x - 3 = 2x + 9"),
            ],
        )
